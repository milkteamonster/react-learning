	...
	return (
		<div className={styles.container}>
			...
			<header className={styles.header}>
				{home ? (
					<>
						<Image priority src='/image/carebear.png' className={utilStyles.borderCircle} height={144} width={190} alt='' />
						<h1 className={utilStyles.heading2Xl}>{name}</h1>
					</>
				) : (
					<>
						<Link href='/'>
							<Image priority src='/image/carebear.png' className={utilStyles.borderCircle} height={108} width={200} alt='' />
						</Link>
